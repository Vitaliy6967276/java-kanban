public class Main {
    public static void main(String[] args) {
        ...
        Subtask subtask1 = manager.generateSubtask(new Subtask("Подзадача 1.1", "Описание подзадачи 1.1", epic1));
        Subtask subtask2 = manager.generateSubtask(new Subtask("Подзадача 1.2", "Описание подзадачи 1.2", epic1));
        Epic epic2 = manager.generateEpic(new Epic("Эпик 2", "Описание эпика 2"));
        Subtask subtask3 = manager.generateSubtask(new Subtask("Подзадача 2.1", "Описание подзадачи 2.1", epic2));
